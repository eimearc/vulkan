...
void EVulkan::createGraphicsPipeline()
{
...
VkShaderModule EVulkan::createShaderModule(const std::vector<char>& code)
{
...
void EVulkan::createDepthResources()
{
...
VkFormat EVulkan::findDepthFormat()
{
...
VkFormat EVulkan::findSupportedFormat(const std::vector<VkFormat>& candidates,
...
void EVulkan::createColorResources()
{
...
VkSampleCountFlagBits EVulkan::getMaxUsableSampleCount()
{
...
void EVulkan::generateMipMaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
{
    ...
    {
        throw std::runtime_error("texture image format does not sipport linear blitting");
    }
...
void EVulkan::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format,
...
VkImageView EVulkan::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels)
{
