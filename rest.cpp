...
bool EVulkan::checkValidationLayerSupport()
{
    uint32_t layerCount;
...
std::vector<const char*> EVulkan::getRequiredExtensions()
{
...
void EVulkan::createImageViews()
{
    ...
    std::cout << "swap chain image views size: " << swapChainImageViews.size() << std::endl;
...
EVulkan::QueueFamilyIndices EVulkan::findQueueFamilies(VkPhysicalDevice device)
{
...
void EVulkan::setupDebugMessenger()
{
